...
import heroImg from '../../assets/estonia-recipe/E-SpottedDog.png'

function KirjuRecipe() {
  return (
    <div id="container">
      <header>
        <logo>
          ...
          <ul className="main-menu">
            ...
            <li>
              ...
              <ul className="submenu">
                ...
                <li>
                  <a href="Recipe-EsVastla.html">Vastlakukkel</a>
                </li>
              </ul>
            </li>
          </ul>
