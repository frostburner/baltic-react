...
import NavLogo from '../../assets/estonia-recipe/balticbites2.png';
import heroImg from '../../assets/estonia-recipe/E-Vastlakukkel.png'

function VastlakukkelRecipe() {
  return (
    <div id="container">
      <header>
        <logo>
          ...
          <ul className="main-menu">
            ...
            <li>
              ...
              <ul className="submenu">
                <li>
                  <a href="Recipe-EsKirju.html">Kirju</a>
                </li>
                <li>
                  <a href="Recipe-EsPirukad.html">Pikurad</a>
                </li>
                <li>
                  <a href="Recipe-EsKama.html">Kama</a>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <div className="row">
        <div className="left">
          <img src={heroImg} alt="Vastlakukkel" />
        </div>
        <div className="right">
...
export default VastlakukkelRecipe;
