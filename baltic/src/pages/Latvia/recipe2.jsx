...
import heroImg from '../../assets/latvia-recipe/Lv-ChocolateKissel.png'
          ...
          <li>
            ...
            <li>
              ...
              <ul className="submenu">
                <li>
                  <a href="/kirju">Kirju</a>
                </li>
                <li>
                  <a href="/kama">Kama</a>
                </li>
                <li>
                  <a href="vastla">Vastlakukkel</a>
                </li>
              </ul>
            </li>
          </ul>
