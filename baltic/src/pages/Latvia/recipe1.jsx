...
import './recipe.css'
import NavLogo from '../../assets/latvia-recipe/balticbites2.png';
import heroImg from '../../assets/latvia-recipe/Lv-CaramelCookies.png'
          ...
          <li>
            ...
            <li>
              ...
              <ul className="submenu">
                <li>
                  <a href="/">Sokolades Kiselis</a>
                </li>
                <li>
                  <a href="/kama">Medus Kuka</a>
                </li>
                <li>
                  <a href="vastla">Rupjmaize ar medu</a>
                </li>
              </ul>
            </li>
          </ul>
